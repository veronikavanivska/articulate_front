...
/**
 * Proxy: POST /api/etl/admin/activateMeinVersion?versionId=...
 * Forwards to backend /etl/admin/activateMeinVersion?versionId=...
...
export default async function handler(req: NextApiRequest, res: NextApiResponse) {
    ...
    try {
        ...
        const target = `${API_GATEWAY.replace(/\/$/, '')}/etl/admin/activateMeinVersion?versionId=${encodeURIComponent(versionId)}`;
        console.log('[proxy/activateMeinVersion] forwarding to', target);
        ...
        console.error('[proxy/activateMeinVersion] error', err);
